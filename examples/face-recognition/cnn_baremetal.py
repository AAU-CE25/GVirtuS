...
# nvcc -shared -Xcompiler -fPIC -o libextension_baremetal.so extension.cu -L ${GVIRTUS_HOME}/lib/frontend -L ${GVIRTUS_HOME}/lib/ -lcudart -lcudnn -lcublas
import time
import ctypes
import numpy as np
...
libextension = ctypes.CDLL("./libextension_baremetal.so")
