...
echo "=== FRONTEND UCX OVER TCP ONLY ==="
...
docker run --rm \
  ...
  -c '
    ...
    echo "=== env check ==="
    env | grep -E "GVIRTUS|UCX|RMA|GPUDIRECT" || true
    ...
    pwd
    ls -lh main.cu dnn_test mobilenetv2-10.onnx squeezenet1.1-7.onnx resnet18-v1-7.onnx vgg16-7.onnx
