...
__attribute__((visibility("default"))) cudaError_t_local cudaEventRecordWithFlags_ptsz() { STUB_LOG("cudaEventRecordWithFlags_ptsz"); return CUDART_STUB_NOT_SUPPORTED; }
__attribute__((visibility("default"))) cudaError_t_local cudaEventRecord_ptsz() { STUB_LOG("cudaEventRecord_ptsz"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaFreeAsync_ptsz() { STUB_LOG("cudaFreeAsync_ptsz"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaGLMapBufferObject() { STUB_LOG("cudaGLMapBufferObject"); return CUDART_STUB_NOT_SUPPORTED; }
__attribute__((visibility("default"))) cudaError_t_local cudaGLMapBufferObjectAsync() { STUB_LOG("cudaGLMapBufferObjectAsync"); return CUDART_STUB_NOT_SUPPORTED; }
__attribute__((visibility("default"))) cudaError_t_local cudaGLRegisterBufferObject() { STUB_LOG("cudaGLRegisterBufferObject"); return CUDART_STUB_NOT_SUPPORTED; }
__attribute__((visibility("default"))) cudaError_t_local cudaGLSetBufferObjectMapFlags() { STUB_LOG("cudaGLSetBufferObjectMapFlags"); return CUDART_STUB_NOT_SUPPORTED; }
__attribute__((visibility("default"))) cudaError_t_local cudaGLSetGLDevice() { STUB_LOG("cudaGLSetGLDevice"); return CUDART_STUB_NOT_SUPPORTED; }
__attribute__((visibility("default"))) cudaError_t_local cudaGLUnmapBufferObject() { STUB_LOG("cudaGLUnmapBufferObject"); return CUDART_STUB_NOT_SUPPORTED; }
__attribute__((visibility("default"))) cudaError_t_local cudaGLUnmapBufferObjectAsync() { STUB_LOG("cudaGLUnmapBufferObjectAsync"); return CUDART_STUB_NOT_SUPPORTED; }
__attribute__((visibility("default"))) cudaError_t_local cudaGLUnregisterBufferObject() { STUB_LOG("cudaGLUnregisterBufferObject"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaGraphLaunch_ptsz() { STUB_LOG("cudaGraphLaunch_ptsz"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaGraphUpload_ptsz() { STUB_LOG("cudaGraphUpload_ptsz"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaGraphicsGLRegisterBuffer() { STUB_LOG("cudaGraphicsGLRegisterBuffer"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaGraphicsMapResources() { STUB_LOG("cudaGraphicsMapResources"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaGraphicsResourceGetMappedPointer() { STUB_LOG("cudaGraphicsResourceGetMappedPointer"); return CUDART_STUB_NOT_SUPPORTED; }
__attribute__((visibility("default"))) cudaError_t_local cudaGraphicsResourceSetMapFlags() { STUB_LOG("cudaGraphicsResourceSetMapFlags"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaGraphicsUnmapResources() { STUB_LOG("cudaGraphicsUnmapResources"); return CUDART_STUB_NOT_SUPPORTED; }
__attribute__((visibility("default"))) cudaError_t_local cudaGraphicsUnregisterResource() { STUB_LOG("cudaGraphicsUnregisterResource"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaMemcpy2DAsync_ptsz() { STUB_LOG("cudaMemcpy2DAsync_ptsz"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaMemcpy3DAsync_ptsz() { STUB_LOG("cudaMemcpy3DAsync_ptsz"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaMemcpyToSymbolAsync_ptsz() { STUB_LOG("cudaMemcpyToSymbolAsync_ptsz"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaMemset2DAsync_ptsz() { STUB_LOG("cudaMemset2DAsync_ptsz"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaStreamAddCallback_ptsz() { STUB_LOG("cudaStreamAddCallback_ptsz"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaStreamBeginCapture_ptsz() { STUB_LOG("cudaStreamBeginCapture_ptsz"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaStreamEndCapture_ptsz() { STUB_LOG("cudaStreamEndCapture_ptsz"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaStreamGetCaptureInfo_v2() { STUB_LOG("cudaStreamGetCaptureInfo_v2"); return CUDART_STUB_NOT_SUPPORTED; }
...
__attribute__((visibility("default"))) cudaError_t_local cudaStreamWaitEvent_ptsz() { STUB_LOG("cudaStreamWaitEvent_ptsz"); return CUDART_STUB_NOT_SUPPORTED; }
